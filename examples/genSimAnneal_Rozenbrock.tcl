...
# setup Generalized Simulated Annealing optimization
...
foreach genTr $trajectory genF $bestf {
    ...
    lappend functionTrajectory [list [dict get $genTr iter] [dict get $genF bestf]]
}
...
$chart Yaxis -name "Rozenbrock function value" -minorTick {show "True"} -min 1e-10 -max 10000 -type "log" -splitLine\
        {show "True"}
